...
t.SQRT_X            = function(i) return math.sqrt(i) end

t.X                 = function(i) return i end

t.X_2               = function(i) return i ^ 2 end

local valEm1        = math.exp(1) - 1
t.EXP_X             = function(i) return (math.exp(i) - 1) / valEm1 end

t.X_3               = function(i) return i ^ 3 end

t.CBRT_X            = function(i) return i ^ (1 / 3) end
...
t.revert            = function(f) return function(r) return f(1 - r) end end
...
atlib.vary          = function(v1, v2, curve, start, fin, p)
    if p > fin then return v2 end
    if p < start then return v1 end
