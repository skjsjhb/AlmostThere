...
public:
  ...
  [[nodiscard]] bool shouldUnload(double absTime) const;
...
class HPBar {
public:
  explicit HPBar(Game &g, HPBarVariant va = HP_NORMAL, unsigned int max = 100, unsigned int cur = 100) : game(g),
                                                                                                         variant(va),
                                                                                                         hpCurrent(
                                                                                                             cur),
                                                                                                         hpMax(max) {};
  ...
  void setMaxHP(unsigned v) { hpMax = v; }
