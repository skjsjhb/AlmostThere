...
void Game::initGame(const std::string &mapId) {
  ...
  for (auto &o : map.objects) {
    ...
    switch (o->type) {
    case NOTE:tck = Note::createNote(std::dynamic_pointer_cast<NoteObject>(o), *this);
      break;
    case SLOT:tck = Slot::createSlot(std::dynamic_pointer_cast<SlotObject>(o), *this);
      break;
    case CAMERA:tck = Camera::createCamera(std::dynamic_pointer_cast<CameraObject>(o), *this);
      break;
    default:--counter;
